namespace MinionBot.Languages.Russian
{
    public class Responses : AbstractLanguage, ILanguage
    {
        ...
        public string WarChannelFailed
            => "Запуск этой команды требует спонсорства на сервере. Если вы патрон, то используйте команду sponsorserver. Так же вы должны иметь разрешение на управление каналом и категориями, в зависимости от указанных параметров.";
