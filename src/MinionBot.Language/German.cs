...
"Set a match date for two participating clans. The date is in UTC. When the two clans match on this day (plus or minus one day) it will be automatically approved. Use `deletematch to undo matches.",
